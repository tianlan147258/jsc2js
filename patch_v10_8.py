...
def patch_d8_cc():
    ...
    new_functions = [
        ...
        '',
        '  // Print constant pool',
        '  v8::internal::PrintF("  --- Constant pool dump (%d entries) ---\\n", bc->constant_pool()->length());',
        '  for (int ci = 0; ci < bc->constant_pool()->length(); ci++) {',
        '    v8::internal::Object obj = bc->constant_pool()->get(ci);',
        '    v8::internal::PrintF("    [%d]: ", ci);',
        '    if (obj.IsString()) {',
        '      v8::internal::OFStream os2(stdout);',
        '      v8::internal::String::cast(obj).Print(os2);',
        '    } else if (obj.IsSmi()) {',
        '      v8::internal::PrintF("%d", v8::internal::Smi::cast(obj).value());',
        '    } else if (obj.IsHeapNumber()) {',
        '      v8::internal::PrintF("%g", v8::internal::HeapNumber::cast(obj).value());',
        '    } else if (obj.IsSharedFunctionInfo()) {',
        '      v8::internal::PrintF("<SharedFunctionInfo>");',
        '    } else if (obj.IsUndefined(v8::internal::GetIsolate())) {',
        '      v8::internal::PrintF("<undefined>");',
        '    } else if (obj.IsTrue(v8::internal::GetIsolate())) {',
        '      v8::internal::PrintF("<true>");',
        '    } else if (obj.IsFalse(v8::internal::GetIsolate())) {',
        '      v8::internal::PrintF("<false>");',
        '    } else if (obj.IsNull(v8::internal::GetIsolate())) {',
        '      v8::internal::PrintF("<null>");',
        '    } else if (obj.IsTheHole(v8::internal::GetIsolate())) {',
        '      v8::internal::PrintF("<the_hole>");',
        '    } else {',
        '      v8::internal::PrintF("<other>");',
        '    }',
        '    v8::internal::PrintF("\\n");',
        '  }',
        '  v8::internal::PrintF("  --- End constant pool ---\\n");',
        '',
        '  v8::internal::PrintF("\\n");',
        '',

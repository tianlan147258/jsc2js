...
def patch_d8_cc():
    ...
    new_functions = [
        ...
        '      v8::internal::Handle<v8::internal::BytecodeArray> inner_bc((*shared_handle).GetBytecodeArray(), isolate);',
        ...
        '',
        '    std::unordered_set<uintptr_t> visited;',
        '    v8::internal::Handle<v8::internal::BytecodeArray> bc((*fun).GetBytecodeArray(), isolate);',
